<?php
	...
	*/
	...
	if(trim(!empty($_POST['usermail']))){
		$body.='<p><strong>usermail:</strong>'.$_POST['usermail']. '</p>';
	}		
	if(trim(!empty($_POST['userphone']))){
		$body.='<p><strong>userphone:</strong>'.$_POST['userphone']. '</p>';
	}		
	if(trim(!empty($_POST['usercountry']))){
		$body.='<p><strong>usercountry:</strong>'.$_POST['usercountry']. '</p>';
	}		
	if(trim(!empty($_POST['usermessage']))){
		$body.='<p><strong>usermessage:</strong>'.$_POST['usermessage']. '</p>';
	}		
